...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xff356853),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff74a991),
      onTertiaryContainer: Color(0xff00140c),
      ...
      tertiaryFixed: Color(0xffb8eed4),
      onTertiaryFixed: Color(0xff002115),
      tertiaryFixedDim: Color(0xff9cd2b9),
      onTertiaryFixedVariant: Color(0xff1b503c),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xff164c39),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff4b7f69),
      ...
      tertiaryFixed: Color(0xff4b7f69),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff326551),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff164c39),
      onTertiaryContainer: Color(0xffffffff),
      ...
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff164c39),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff003424),
      onTertiaryFixedVariant: Color(0xffffffff),
      surfaceDim: Color(0xffdad9df),
      surfaceBright: Color(0xfff9f9ff),
      surfaceContainerLowest: Color(0xffffffff),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xffa0d6bd),
      onTertiary: Color(0xff001b11),
      tertiaryContainer: Color(0xff679b84),
      ...
      tertiaryFixedDim: Color(0xff9cd2b9),
      onTertiaryFixedVariant: Color(0xff033e2c),
      surfaceDim: Color(0xff121317),
      surfaceBright: Color(0xff38393e),
      surfaceContainerLowest: Color(0xff0c0e12),
      surfaceContainerLow: Color(0xff1a1c20),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      tertiaryContainer: Color(0xffa0d6bd),
      onTertiaryContainer: Color(0xff000000),
      ...
      tertiaryFixed: Color(0xffbcf3d8),
      onTertiaryFixed: Color(0xff000000),
      tertiaryFixedDim: Color(0xffa0d6bd),
